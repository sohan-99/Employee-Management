...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-slate-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>Stellar Scape Innovations <br />Providing reliable tech since 1992</p>
                </aside>
