    ...
    return (
        <div>
            ...
            <div className="flex  space-x-2 lg:justify-center justify-center my-4 md:my-5 lg:my-6">
                ...
                <img className='lg:w-[35%] md:w-[140px] w-[20%] ' src="https://i.ibb.co/02BY6Zx/CMMI-DEV.png" alt="" />
                <img className="lg:w-full w-[20%]" src="https://i.ibb.co/kK0TDZW/ISO-9001-2015-logo-1-1000x1000-1-ovsqm00gs725926nzmp12awuz3r597i293giate7zc.png" alt="" />
            </div>
